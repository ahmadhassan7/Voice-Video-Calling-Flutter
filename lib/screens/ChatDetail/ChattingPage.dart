...
class ChatScreenState extends State<ChatScreen> {
  ...
  readLocal() async {
    ...
    // print(preferences.getString('wallpaper'));
    // print(preferences.getString('wallpaper'));
    ...
    // wallpaper =  preferences.getString('wallpaper');
      ...
      child: Stack(
        children: [
          Container(
            ...
            child: FittedBox(
                fit:BoxFit.cover,
                child: !prefs.containsKey('wallpaper') ? Container() :Image.file(File(prefs.getString('wallpaper')))),
          ),
          Column(
            children: [
              createListMessages(),
