...
//          .toList();
  ...
  loadData(phoneNo) async {
    final data =  await Firestore.instance.collection('Users').where('phone',isEqualTo: phoneNo).getDocuments().then((value) {
        ...
        child: _contacts != null
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return ListTile(
              ...
              title: Text(c.displayName ?? "", style: TextStyle(color: Theme.of(context).textTheme.bodyText2.color),),
              // trailing: FlatButton(
              //
              //
              //
