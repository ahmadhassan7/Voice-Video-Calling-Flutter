...
class CheckBoxListForGroup extends StatefulWidget {
  final DocumentSnapshot data;

  CheckBoxListForGroup({
    @required this.data,
  });
  @override
  _CheckBoxListForGroupState createState() => _CheckBoxListForGroupState();
}

class _CheckBoxListForGroupState extends State<CheckBoxListForGroup> {
            ...
            child: Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Checkbox(
                    // value: true ,
                    // value: isSelected[isSelectedIndex-1] ,
                    value: isSelectedcheck,
                    onChanged: (bool value) {
                      setState(() {
                        isSelectedcheck = value;
                        // isSelected[isSelectedIndex-1] = value;
                        // print(isSelected.length);
                        // print(isSelected[isSelectedIndex-1]);
                      });
                    },
                  )
                ],
